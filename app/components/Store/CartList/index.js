        ...
        <div key={index} className='item-box'>
          <div className='item-details'>
            <Container>
              ...
              <Row className='mb-2 align-items-center'>
                <Col xs='9'>
                  <p className='item-label text-white'>Price</p>
                </Col>
                <Col xs='3' className='text-right'>
                  <p className='value price text-white'>{` $${item?.totalPrice}`}</p>
                </Col>
              </Row>
              <Row className='mb-2 align-items-center'>
                <Col xs='9'>
                  <p className='item-label text-white'>Quantity</p>
                </Col>
                <Col xs='3' className='text-right'>
                  <p className='value quantity text-white'>{` ${item.quantity}`}</p>
                </Col>
              </Row>
            </Container>
          </div>
